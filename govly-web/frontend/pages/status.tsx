              ...
              <div key={app.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="px-6 pb-6">
                  <div className="flex gap-2">
                    <button
                      onClick={() => router.push(`/edit-application/${app.id}`)}
                      className="flex-1 px-3 py-2 bg-blue-100 text-blue-700 text-sm rounded-lg hover:bg-blue-200 transition-colors flex items-center justify-center gap-2"
                    >
