...
# Setup Script to Run from Inside govly-web Directory
# Run this script from /home/ubuntu/Govly/govly-web

set -e

echo "🚀 Starting Govly Setup from govly-web directory..."
...
echo "✅ Confirmed: Running from govly-web directory"
