...
# Fix Python Package Issues Script
# This script creates missing __init__.py files and fixes package structure
...
echo "📝 Step 1: Creating missing __init__.py files..."
# Create __init__.py files for all directories
find . -type d -name "models" -exec touch {}/__init__.py \;
find . -type d -name "chains" -exec touch {}/__init__.py \;
find . -type d -name "utils" -exec touch {}/__init__.py \;
find . -type d -name "rag" -exec touch {}/__init__.py \;
find . -type d -name "prompts" -exec touch {}/__init__.py \;
...
echo "📝 Step 5: Setting PYTHONPATH..."
...
echo "📝 Step 7: Creating a startup script with proper PYTHONPATH..."
...
echo "📝 Step 8: Updating PM2 ecosystem configuration..."
cd ..
...
echo "📝 Step 9: Stopping and restarting PM2 applications..."
pm2 delete all
...
echo "✅ Python package issues fixed!"
echo ""
