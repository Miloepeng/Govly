...
# Fix Missing IntentDetectionResponse Class Script
# This script adds the missing IntentDetectionResponse class to response_models.py

set -e

echo "🔧 Adding missing IntentDetectionResponse class..."
...
echo "📝 Step 1: Adding missing classes to response_models.py..."
...
try:
    from models.response_models import ChatResponse, IntentDetectionResponse
...
echo "✅ Missing IntentDetectionResponse class added!"
echo ""
